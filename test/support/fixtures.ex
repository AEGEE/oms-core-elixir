defmodule OmscoreWeb.Fixtures do
  ...
  @valid_payment_attrs %{amount: "120.5", comment: "some comment", currency: "euro", starts: ~D[2010-04-17], expires: ~D[3010-04-17], invoice_address: "some invoice_address", invoice_name: "some invoice_name"}
