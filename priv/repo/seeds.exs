...
if Mix.env() == :dev && Repo.all(Member) == [] do
  {:ok, microservice_member} = Members.create_member(%{about_me: "I am a microservice. I have a user account so the system can access itself from within, don't delete me.", address: "Europe", date_of_birth: ~D[2010-04-17], first_name: "Microservice", gender: "machine", last_name: "Microservice", phone: "+123456789", user_id: 1})
  {:ok, member} = Members.create_member(%{about_me: "I code shit", address: "Europe", date_of_birth: ~D[2010-04-17], first_name: "Nico", gender: "not specified", last_name: "Westerbeck", phone: "+1212345678", user_id: 11})
  {:ok, member2} = Members.create_member(%{about_me: "I also code shit", address: "Russian tundra", date_of_birth: ~D[2010-04-17], first_name: "Sergey", gender: "programmer", last_name: "Peshkov", phone: "+1212345678", user_id: 12})
